...
const Contact = () => {
    return(
     ...
     <a href="mailto:salapantan.judealliahsit2011@gmail.com" target='-blank' className="email font-medium" ><p className='md:tracking-[.5rem]'>salapantan.judealliahsit2011@gmail.com</p></a> 
     </div>
